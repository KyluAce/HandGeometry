...
public class CameraCheckUser extends Activity implements CvCameraViewListener2 {
    ...
    public void cameraClick(View v) {
        ...
        new HttpCamera(this).execute("http://192.168.43.77:8080/geometry-1.0.0-BUILD-SNAPSHOT/checkgeometry", toJson());
    }
    ...
    private class HttpCamera extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(json.isNull("name")) {
                    Toast.makeText(activity, "Odmowa dostepu",
                    ...
                    Intent intent = new Intent(activity, UserShowActivity.class);
                    intent.putExtra("namesurname", json.getString("name") + " " + json.getString("surname"));
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                ...
                Toast.makeText(activity, "Blad polaczenia z serverem",
                        Toast.LENGTH_LONG).show();
            }
